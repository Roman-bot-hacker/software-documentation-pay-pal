...
import com.kruk.paypal.service.UserAccountService;
...
/**
 * REST controller for managing {@link com.kruk.paypal.domain.UserAccount}.
 */
@RestController
@RequestMapping("/api")
public class UserAccountResource {
    ...
    public List<UserAccount> getAllUserAccounts(@RequestParam(required = false, defaultValue = "false") boolean eagerload) {
