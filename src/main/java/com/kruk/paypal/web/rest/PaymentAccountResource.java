...
import com.kruk.paypal.service.PaymentAccountService;
...
/**
 * REST controller for managing {@link com.kruk.paypal.domain.PaymentAccount}.
 */
@RestController
@RequestMapping("/api")
public class PaymentAccountResource {
    ...
    public ResponseEntity<PaymentAccount> updatePaymentAccount(@Valid @RequestBody PaymentAccount paymentAccount) throws URISyntaxException {
        ...
        return ResponseEntity.ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, paymentAccount.getId().toString()))
            .body(result);
    }
